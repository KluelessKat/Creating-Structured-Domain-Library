...
output='/Users/katherinezhang/Downloads/Kappel_2026SpringRotation/jpl_code/Creating-Structured-Domain-Library/2_domainLibraryStructuredSeq_meta.tsv'
...
for sequence in df["Domain Sequence"]:#Go through your domain sequences to make disordered predictions for each one
    ...
    predictions = meta.predict_disorder(sequence)
